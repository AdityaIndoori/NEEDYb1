...
public class H_MartCartActivity extends AppCompatActivity implements H_MartCartRecyclerViewAdapter.H_MartCartItemClickeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int totalBill = getTotalBill(4,pricePerProduct,quantityArrayInt);
        textViewCartBill.setText(4 + " Items" + " - " + "₹. " + totalBill + "/-");
        setTitle("Review Order");
    }

    private int getTotalBill(int numberOfProducts, ArrayList<Integer> pricePerProduct, ArrayList<Integer> quantityArrayInt) {
        int totalBill = 0;
    ...
    public void onH_MartCartItemClicked(int ViewId, String data) {
        MainActivity.setToast("Deleted", getApplicationContext());
    }
}
